declare module 'weatherlink' {
  function WeatherLink(arg: Record<'apiKey' | 'apiSecret', string>): {
    getAllStations: () => Promise<import('./models').Stations>;
    getStations: (arg: { stationIds: number[] }) => Promise<import('./models').Stations>;
    ...
    getCurrent: (arg: { stationId: number }) => Promise<import('./models').CurrentConditions>;
