...
import { EpaHourlyForecast, EpaHourlyForecastItem, Wind as WindModel } from '../../../../models/api';
...
const UVIndexIcon = (uvValue: number) => (
  <svg className={styles['uvindex__icon']} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g>
      ...
      <path
        className={uvValue <= 2 ? styles['uvindex__icon__path--hidden'] : ''}
        d="M2.5 12C2.224 12 2 11.776 2 11.5C2 11.224 2.224 11 2.5 11H4.5C4.776 11 5 11.224 5 11.5C5 11.776 4.776 12 4.5 12H2.5Z"
      />
      <path
        className={uvValue <= 3 ? styles['uvindex__icon__path--hidden'] : ''}
        d="M2.5 10C2.224 10 2 9.776 2 9.5C2 9.224 2.224 9 2.5 9H4.5C4.776 9 5 9.224 5 9.5C5 9.776 2.5 10 2.5 10Z"
      />
      <path
        className={uvValue <= 5 ? styles['uvindex__icon__path--hidden'] : ''}
        d="M2.5 8C2.224 8 2 7.776 2 7.5C2 7.224 2.224 7 2.5 7H4C4.276 7 4.5 7.224 4.5 7.5C4.5 7.776 4.276 8 4 8H2.5Z"
      />
      <path
        className={uvValue <= 7 ? styles['uvindex__icon__path--hidden'] : ''}
        d="M2.5 6C2.224 6 2 5.776 2 5.5C2 5.224 2.224 5 2.5 5H3.5C3.776 5 4 5.224 4 5.5C4 5.776 3.776 6 3.5 6H2.5Z"
      />
      <path
        className={uvValue <= 10 ? styles['uvindex__icon__path--hidden'] : ''}
        d="M2.5 4C2.224 4 2 3.776 2 3.5C2 3.224 2.224 3 2.5 3H4C4.276 3 4.5 3.224 4.5 3.5C4.5 3.776 4.276 4 4 4H2.5Z"
      />
    </g>
  </svg>
);
...
export default function UVIndex({ epaData }: { epaData?: EpaHourlyForecast }) {
  const uvIndex = epaData?.hourlyForecast?.reduce((prev: EpaHourlyForecastItem, current: EpaHourlyForecastItem) =>
